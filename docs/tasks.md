...
| M-023 | Dictionary UX | Split user terms from built-in read-only terms | IN PROGRESS | [#23](https://github.com/6spot/Morie/issues/23) | [`M-023`](./tasks/M-023-dictionary-readonly-sections.md) |
