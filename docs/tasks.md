...
Current management follows the native M-008 structure with separate History, Dictionary and Personal Memory sections. M-009's task record holds current test/build/layout evidence; earlier task counts are historical evidence for their respective implementations.
