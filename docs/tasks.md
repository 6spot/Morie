...
| M-020 | Architecture | Organize source and tests by feature/platform ownership without behavior changes | IN PROGRESS | [#18](https://github.com/6spot/Morie/issues/18) / [PR #19](https://github.com/6spot/Morie/pull/19) | [`M-020`](./tasks/M-020-source-tree-organization.md) |
