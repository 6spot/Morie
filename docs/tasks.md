...
| M-044 | Architecture | Experimental Control Center process isolation; retained as evidence, not merge target | BLOCKED | [PR #106](https://github.com/6spot/Morie/pull/106) | [`M-044`](./tasks/M-044-control-center-process-boundary.md) |
| M-045 | Architecture | Keep Morie as the primary GUI app and move voice input into a background Runtime agent | IN PROGRESS | — | [`M-045`](./tasks/M-045-morie-runtime-agent.md) |
