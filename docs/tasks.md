...
| M-021 | Architecture | Extract live Capture session lifecycle from AppController | IN PROGRESS | [#20](https://github.com/6spot/Morie/issues/20) / [PR #21](https://github.com/6spot/Morie/pull/21) | [`M-021`](./tasks/M-021-capture-session-controller.md) |
