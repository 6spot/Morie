...
- Native Settings, History Form/disclosures and the existing processing HUD expose the feature. Diagnostics contain only counts, status and duration; fixed failure reasons never include raw model error content.
